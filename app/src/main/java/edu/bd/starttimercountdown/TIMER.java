...
public class TIMER extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = new Intent(TIMER.this, StartTimerService.class);
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(br, new IntentFilter(StartTimerService.START_TIMER));
    }
    ...
    protected void onDestroy() {
        stopService(new Intent(this, StartTimerService.class));
        super.onDestroy();
    }
